...
add wave -noupdate -radix unsigned /t_fifo/u_fifo/WRDAT
...
add wave -noupdate -radix unsigned /t_fifo/u_fifo/RDDAT
add wave -noupdate -radix hexadecimal /t_fifo/u_fifo/RDLEV
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1049153583 fs} 0}
...
update
WaveRestoreZoom {976998870 fs} {1153676928 fs}
